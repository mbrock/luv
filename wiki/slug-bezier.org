...
* NEXT Render a zpb-ttf glyph through Slug
:PROPERTIES:
:ID: DTBI99
:END:
...
The remaining part of this mark is production evidence rather than basic font
rendering: exercise the portable draw on the Vulkan backend, compare boundary
pixels with a small CPU winding oracle, and test dynamic dilation separately.
