...
This first serializer describes one glyph beginning at texture origin zero.
Atlas allocation and relocation, resource upload, and rendering from those
resources remain open; those steps must preserve the fixed-width addressing
assumed by the released pixel shader.
