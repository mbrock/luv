...
| =block-mesh-snapshot= | immutable one-cell halo | expanded-halo coordinates and repeated sample offsets |
...
while the immutable snapshot shares expanded-halo addressing for both fields.
