...
* NEXT Publish generated media out of band
:PROPERTIES:
:ID: 0BGP3P
:END:
...
image and video responses, and the remaining retention question has an answer:
which historical annex keys remain reachable when recipes or figures change.
