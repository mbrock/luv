...
adds the first production-data plate: Lisp emits one exact atlas patch, a
checked Typst data file detects drift, and one CeTZ projection compares its
occupancy, whole geometry, polygon structure, and ownership on paper and web.
