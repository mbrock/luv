...
bracket links with =file:=, =https:=, =id:=, =lisp:= or no scheme, a bare
...
figure it mentions (title, page, status, opening prose), and a few lines
of script in =site.js= show the card as a top-layer =popover= beside the
mention on hover, focus, or a first tap, placed below the link or above it
when the viewport is short.  The site stays static and the links stay
plain links.
