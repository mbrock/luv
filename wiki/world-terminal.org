...
meaningful terminal input, while a boat or book may have a world interaction
verb for dismounting or closing.  The gameplay action which established a
focus should call [[lisp:unfocus-luvcraft-session]] to reverse it.
