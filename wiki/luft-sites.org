...
This historical material-width experiment made the site's ownership concrete.
...
edges.  The variable-width evaluator contracted that exact T-junction by
retaining the collinear middle point in the surviving neighbour.  In the
five-cell regression, three unmatched edges became one repair and a closed
surface.  Its triangle
...
The removed mechanism, strictly as measured: near a seam a flat surface was
emitted as face pieces, one-tick rim bands, and one-tick corner
junctions; each patch resolved its material independently through its
own vertex-star closure.  This material-aware terrain path has since been
deleted in favor of the fixed 256-star atlas.
