...
(define-instruction constant-composite (&rest constituents)
  (:opcode 44) (:result :typed) (:operands :id))
...
(define-instruction selection-merge (merge-block selection-control)
  (:opcode 247)
  (:operands :id (:enum selection-control)))
...
(define-instruction emit-mesh-tasks-ext
    (group-count-x group-count-y group-count-z &rest payload)
  (:opcode 5294)
  (:operands :id :id :id :id))
(define-instruction set-mesh-outputs-ext (vertex-count primitive-count)
  (:opcode 5295)
  (:operands :id :id))
...
(define-enumeration execution-mode
  ...
  (output-vertices 26)
  (output-points 27)
  (output-lines-ext 5269)
  (output-primitives-ext 5270)
  (output-triangles-ext 5298))
