...
shader-validate:
	...
	@./scripts/dev sbcl --noinform --non-interactive \
		--eval '(require :asdf)' \
		--eval '(handler-bind ((warning (function muffle-warning))) (progn (asdf:load-asd (truename "luv.asd")) (asdf:load-asd (truename "telegram.asd")) (asdf:load-asd (truename "luvcraft.asd")) (asdf:load-system :luvcraft)))' \
